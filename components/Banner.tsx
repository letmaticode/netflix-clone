...
function Banner({ netflixOriginals }: Props) {
    ...
    return (
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
            ...
            <p className="max-w-xs drop-shadow-md text-xs md:max-w-lg md:text-lg lg:max-w-2xl lg:text-2xl">{movie?.overview}</p>

            <div className="flex space-x-3 shado">
                <button className="bannerButton bg-white text-black">
                    <FaPlay className="text-black md:h-7 md:w-7" /> Play
                </button>
